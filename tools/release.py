...
<main>
  ...
  <ol>
    ...
    <li>Start it from Kodi's <strong>home menu → Add-ons → Program add-ons →
        tofa for Kodi</strong>. Not from Settings → Add-ons → My add-ons: that
        ...
        listing, which works under any skin but is not the same thing. Add it
        to Favourites and it is one press from the home menu.</li>
  </ol>
